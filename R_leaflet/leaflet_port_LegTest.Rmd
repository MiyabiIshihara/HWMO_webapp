...
HFires <- geojsonio::geojson_read("../wireframe/data//HI_Wildfires_m.geojson", what = "sp")
...
```{r}
#Heatmap
  addHeatmap(m, lng = ~Long, lat = ~Lat, data = HFires,
...
# #GeoJSONHeatmap
#   addGeoJSONHeatmap(m, geojson = "../wireframe/data//HI_Wildfires_m.geojson",
#                     intensityProperty = HFires$Total_Ac,
#              blur = 20,
#              group = "Hawaii fires"
#                   
#                   ) 
...
#fillColor = ~pal2(haz_dat$FIREPROTOT)

  addPolygons(m, data = haz_dat, color = '#000000', weight = 1,
             # fillColor = ~colorNumeric(pal = pal1, n = 4, haz_dat$SUBD_TOT),
              fillColor = ~pal1(haz_dat$SUBD_TOT),
              opacity = 1.0,
              ...
              popup = paste("<p align = 'right'><font size = '3'><b>",haz_dat$AreaName, 
                            "</b></font> </br><font size = '2'><mark>Total score: <b>", haz_dat$SUBD_TOT, "</font></mark></b>",
                            "</br>Ingress/Egress: <b>", haz_dat$Ing_Eg,
   ...
   addPolygons(data = haz_dat, weight = 1, color = '#aaaaaa',
              fillColor = ~pal2(haz_dat$FIREPROTOT),
              opacity = 1.0,
              highlightOptions = highlightOptions(stroke = "#ff0505",
                                                  weight = 4.0,
    ...
    addLegend(pal = pal2, labels = haz_dat$FIREPROTOT, values = haz_dat$FIREPROTOT, title = "Fire Prot"
