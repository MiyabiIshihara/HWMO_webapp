...
#Polygon data
  ...
  addPolygons(data = haz_dat, color = '#000000', weight = 1,
              ...
              popup = paste("<mark>",haz_dat$AreaName,
                            ...
                            "</mark></br><b>Vegetation type: </b>", haz_dat$Veg_Type,
                            "</mark></br><b>Fuel loading: </b>", haz_dat$Fuel_Load,
                            "</mark></br><b>Fuel structure: </b>", haz_dat$Fuel_Strc,
                            "</mark></br><b>Defensible space: </b>", haz_dat$Def_Space
              ),
  ...
  addPolygons(data = haz_dat, color = '#000000', weight = 1,
              ...
              popup = paste("<mark>",haz_dat$AreaName,
                            "</mark></br><b>Proximity of flamable fuel: </b>", haz_dat$Prox_Flam,
                            "</mark></br><b>Roofing: </b>", haz_dat$Roof_Asmb,
                            "</mark></br><b>Siding: </b>", haz_dat$Sid_Sof,
                            "</mark></br><b>Under-skirting: </b>", haz_dat$Undr_Skrt,
                            "</mark></br><b>Utilities placement: </b>", haz_dat$Utlty_Plmt,
                             "</mark></br><b>Structural ignitability: </b>", haz_dat$Strc_Ign
              ),
  ...
  addPolygons(data = haz_dat, color = '#000000', weight = 1,
              ...
              popup = paste("<mark>",haz_dat$AreaName,
                            ...
                            "</mark></br><b>Avg rain (1-6): </b>", haz_dat$Avg_Rain,
                            "</mark></br><b>Prevailng wind (1-4): </b>", haz_dat$Prev_Wind,
                            "</mark></br><b>Seasonal hazard condition: </b>", haz_dat$Seas_Haz,
                            "</mark></br><b>Ignition risk: </b>", haz_dat$Ign_Risk,
                             "</mark></br><b>Topography: </b>", haz_dat$Top_Adv
              ),
  ...
  # Fire Protection score
   addPolygons(data = haz_dat, color = '#000000', weight = 1,
              ...
              popup = paste("<mark>",haz_dat$AreaName,
                            ...
                            "</mark></br><b>Response time: </b>", haz_dat$Rspn_Time,
                            "</mark></br><b>Fire station proximity: </b>", haz_dat$Prox_Stn,
                            "</mark></br><b>Fire dept training: </b>", haz_dat$FD_Trng,
                            "</mark></br><b>Wildland firefighting capability: </b>", haz_dat$Wild_Cap,
                            "</mark></br><b>Interagency cooperation: </b>", haz_dat$IntAgCoop,
                            "</mark></br><b>Local emergency operations: </b>", haz_dat$Loc_Ops,
                            "</mark></br><b>Community planning: </b>", haz_dat$Com_Plan,
...
# LAYER CONTROLS
  addLayersControl(
    ...
    baseGroups = c("Subdivision Hazard Rating", "Vegetation Hazard Rating", "Building Hazard Rating", "Fire Environment Hazard Rating", "Fire Protection Score", "Median HH income",  
