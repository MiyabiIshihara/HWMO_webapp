...
```{r cwpp}
cwpp_dat <- st_read("../wireframe/data/CWPP/ALL_CWPP.shp")
...
pal_cwpp <- colorFactor(
       domain = cwpp_dat$Status, ### I would guess this is the problem area
